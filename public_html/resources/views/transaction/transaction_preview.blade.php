            ...
            <table border="1" cellspacing="0" style="width: 100%; text-align: center;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($tindakan->biayalain, 0, ',', '.') }}</td>
                        <td>{{ $tindakan->keteranganlain }}</td>
                        <td>
                                        ...
                                        <form action="/transaction/tindakan/edit" method="post">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" name="biaya_lain" type="text" required id="biaya_lainEdit" value="{{ $tindakan->biayalain }}" />
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="">Keterangan</label>
                                                    <input class="form-control" name="keterangan_lain" type="text" required id="keterangan_lainEdit" value="{{ $tindakan->keteranganlain }}" />
                                                </div>
                                            </div>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            Rp. {{number_format($transaction->transaction_tindak->sum('subtotal'), 0, ",", ".")}}
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group has-float-label mb-3">
                        ...
                        <select onchange="assignValueTindakan(this)" required class="form-control" name="tindakan_id" id="tindakan_id">
                            ...
                            <option value="{{ $item->id }}-{{ $item->nama_tindakan }}-{{ $item->total_harga }}-{{ $item->biaya_lain }}-{{ $item->keterangan }}">{{ $item->nama_tindakan }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group has-float-label mb-3">
