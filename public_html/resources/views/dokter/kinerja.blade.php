...
<div class="card mt-3">
    <div class="card-body">
        <div class="card-title d-flex justify-content-between" id="testyoyy">
            ...
            <a href="/kinerja/download?dokter_id={{ $dataInfo['dokter_id'] }}&startDate={{ $dataInfo['startDate2'] }}&endDate={{ $dataInfo['endDate2'] }}&total={{ $total }}" class="btn btn-success">Download
                Excel</a>
        </div>
        <table border="1" cellspacing="0" id="table_kinerja">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td rowspan="{{ count($transaction->transaction_tindak) + 1 }}">{{ $transaction->pasien ? $transaction->pasien->nama_pasien : "" }}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>Rp. {{ number_format($tindakan->quantity * $tindakan->tindakan->jasa_medis ?? "", 0, ',', '.') }}</td>
                    <td>Rp. {{ number_format($tindakan->biayalain, 0, ',', '.') }}</td>
